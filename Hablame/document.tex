...
\begin{document}
	...
	% sein)
	%% we have no literature, so we do not need it
	%\addcontentsline{toc}{section}{Literatur}
	\newpage
	
	\input{ks/architecture_general.tex}
	
	\input{ks/service_api_lib.tex}
	
	\input{backend/pages/backend.tex}
	
	\input{dh/android.tex}
	
	\input{outlook/pages/outlook.tex}
\end{document}
